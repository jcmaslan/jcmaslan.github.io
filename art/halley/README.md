...
- **27 Mathematical Functions**: Polynomials, trigonometric, hyperbolic, and exponential functions
- **15 Color Schemes**: Rainbow, fire, ocean, MATLAB-style HSV, and more
- **7 Gallery Presets**: Curated views showcasing stunning fractal patterns
